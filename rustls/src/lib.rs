...
/// This internal `atomic_sync` module aliases the `Arc` implementation to allow downstream forks
...
mod sync {
    // NOTE: update here may require update in `admin/use-portable-atomic-arc`.
