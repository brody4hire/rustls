...
pub struct ServerConfig {
    ...
    pub session_storage: RcX<dyn StoresServerSessions>,

    /// How to produce tickets.
    pub ticketer: RcX<dyn ProducesTickets>,
    ...
    pub cert_resolver: RcX<dyn ResolvesServerCert>,
...
impl ServerConfig {
    ...
    pub fn builder_with_provider(
        ...
        ConfigBuilder {
            ...
            time_provider: rcx_from_cfgx!(DefaultTimeProvider),
            side: PhantomData,
        }
    }
