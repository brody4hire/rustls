    ...
    pub fn with_webpki_verifier(
        ...
        ConfigBuilder {
            state: WantsClientCert {
                ...
                verifier: rcx_from_cfgx!(verifier),
...
impl ConfigBuilder<ClientConfig, WantsClientCert> {
    ...
    pub fn with_client_cert_resolver(
        ...
        ClientConfig {
            ...
            client_auth_cert_resolver: rcx_from_cfgx!(client_auth_cert_resolver),
            versions: self.state.versions,
            enable_sni: true,
            ...
            cert_compression_cache: rcx_from_cfgx!(compress::CompressionCache::default()),
