...
impl Tls12ClientSessionValue {
    ...
    pub(crate) fn ticket(&mut self) -> CfgX<PayloadU16> {
        CfgX::clone(&self.common.ticket)
    }
...
pub struct ClientSessionCommon {
    ...
    epoch: u64,
    lifetime_secs: u32,
    server_cert_chain: CfgX<CertificateChain<'static>>,
}
...
impl ClientSessionCommon {
    fn new(
        ...
        Self {
            ...
            server_cert_chain: CfgX::new(server_cert_chain),
        }
    }
