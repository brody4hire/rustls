...
impl ConfigBuilder<ClientConfig, WantsClientCert> {
    ...
    pub fn with_client_cert_resolver(
        ...
        ClientConfig {
            ...
            // XXX
            client_auth_cert_resolver: panic!("XXX"), //cfgrc_with_cfg!(client_auth_cert_resolver),
            versions: self.state.versions,
            enable_sni: true,
            // XXX
            verifier: panic!("XXX"), //rcx_new!(self.state.verifier),
            ...
            // XXX XXX
            time_provider: panic!("XXX"), //CfgRc::new(self.time_provider),
