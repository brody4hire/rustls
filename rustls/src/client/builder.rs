...
impl ConfigBuilder<ClientConfig, WantsVerifier> {
    ...
    pub fn with_root_certificates(
        self,
        root_store: impl Into<Boxx<webpki::RootCertStore>>,
    ...
    pub fn with_webpki_verifier(
        self,
        verifier: Boxx<WebPkiServerVerifier>,
    ) -> ConfigBuilder<ClientConfig, WantsClientCert> {
        ConfigBuilder {
...
impl ConfigBuilder<ClientConfig, WantsClientCert> {
    ...
    pub fn with_client_auth_cert(
        ...
        Ok(self.with_client_cert_resolver(Boxx::new(SingleCertAndKey::from(certified_key))))
    }

    /// Do not support client auth.
    pub fn with_no_client_auth(self) -> ClientConfig {
        self.with_client_cert_resolver(Boxx::new(handy::FailResolveClientCert {}))
    }

    /// Sets a custom [`ResolvesClientCert`].
    pub fn with_client_cert_resolver(
        self,
        client_auth_cert_resolver: Boxx<dyn ResolvesClientCert>,
    ) -> ClientConfig {
        ClientConfig {
            provider: self.provider,
