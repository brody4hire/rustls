...
pub struct ClientConfig {
    ...
    pub cert_compression_cache: RcX<compress::CompressionCache>,
...
impl ClientConfig {
    ...
    pub fn builder_with_provider(
        ...
        ConfigBuilder {
            state: WantsVersions {},
            provider: rcx_from_cfgx!(provider),
            time_provider: rcx_new_with_cfg!(DefaultTimeProvider),
            side: PhantomData,
        }
    }
    ...
    pub fn builder_with_details(
        ...
        ConfigBuilder {
            state: WantsVersions {},
            provider: rcx_from_cfgx!(provider),
            time_provider: rcx_from_cfgx!(time_provider),
            side: PhantomData,
        }
    }
...
impl Resumption {
    ...
    pub fn in_memory_sessions(num: usize) -> Self {
        Self {
            store: rcx_from_cfgx!(super::handy::ClientSessionMemoryCache::new(num)),
    ...
    pub fn disabled() -> Self {
        Self {
            store: rcx_new_with_cfg!(NoClientSessionStorage),
...
pub(super) mod danger {
    ...
    impl DangerousClientConfig<'_> {
        ...
        pub fn set_certificate_verifier(&mut self, verifier: CfgX<dyn ServerCertVerifier>) {
            self.cfg.verifier = rcx_from_cfgx!(verifier);
        }
    }
}
